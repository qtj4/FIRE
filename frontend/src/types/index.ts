...
export type AssistantWidgetKind = 'bar' | 'doughnut' | 'list' | 'stat';
export type AssistantWidgetSource =
  | 'byCity'
  | 'byType'
  | 'bySentiment'
  | 'byOffice'
...
export interface AssistantWidgetPlan {
  kind: AssistantWidgetKind;
  source: AssistantWidgetSource;
  title: string;
